...
const ServiceCard = (props) => {
  ...
  return (
    <UpRevealBox>
    <div className={`relative w-full lg:w-64 h-[250px] lg:h-[500px] p-4 lg:p-8 rounded-xl box-shadow flex flex-col justify-end overflow-hidden hover:scale-105 lg:hover:scale-110 transition ${style}`}>
