    ...
    >
      <div className="w-full h-full flex flex-col lg:flex-row items-center justify-center lg:justify-between relative">
        ...
        <div className="absolute lg:relative bottom-5 lg:bottom-auto flex lg:flex-col gap-[30px]">
          <UpRevealBox>
            <div
              onClick={() => setBgHome("bg-home1")}
              className="w-20 h-20 lg:w-[170px] lg:h-[120px] bg-home1 bg-cover rounded-xl hover:scale-105 transition"
            ></div>
            </UpRevealBox>
            <UpRevealBox>
          <div
            onClick={() => setBgHome("bg-home2")}
            className="w-20 h-20 lg:w-[170px] lg:h-[120px] bg-home2 bg-cover rounded-xl hover:scale-105 transition"
          ></div>
          </UpRevealBox>
          <UpRevealBox>
          <div
            onClick={() => setBgHome("bg-home3")}
            className="w-20 h-20 lg:w-[170px] lg:h-[120px] bg-home3 bg-cover rounded-xl hover:scale-105 transition"
          ></div>
          </UpRevealBox>
        </div>
